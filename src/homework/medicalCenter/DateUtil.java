...
public abstract class DateUtil {
    ...
    private static  final SimpleDateFormat SDF_TIME = new SimpleDateFormat("dd/MM/yy hh:mm");
    ...
    public static String dateTimeToString(Date date) { return SDF_TIME.format(date); }
}
